...
export class EvenementMarketingComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.update({
      ...
      description: "Salon professionnel, road show, activation de marque, conférence, journée clients… L'Événement Peter conçoit des événements marketing qui génèrent de l'impact.",
