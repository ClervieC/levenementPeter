...
export class OfficianteCeremonieComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.update({
      title: "Officiante de cérémonie laïque | Kalist Bretagne",
      description: "Kalist célèbre vos moments de vie avec des cérémonies laïques personnalisées : mariage, PACS, renouvellement de vœux, naissance, obsèques. Bretagne & partout dans le monde.",
